		...
		try {
			{
				...
				}
				{
					...
					jTextField2.setBorder(BorderFactory.createTitledBorder("Lsat: ")); 
				}
				{
					jTextField3 = new JTextField();
					getContentPane().add(jTextField3);
					jTextField3.setBounds(63, 91, 280, 21);
					jTextField3.setBorder(BorderFactory.createTitledBorder(" ")); 
				}
				{
					jTextField4 = new JTextField();
					getContentPane().add(jTextField4);
					jTextField4.setBounds(63, 121, 280, 21);
					jTextField4.setBorder(BorderFactory.createTitledBorder("Lr: ")); 
				}
				{
					jTextField5 = new JTextField();
					getContentPane().add(jTextField5);
					jTextField5.setBounds(63, 151, 280, 21);
					jTextField5.setBorder(BorderFactory.createTitledBorder("bandas: ")); 
				}
				{
					...
					jButton1.setBorder(BorderFactory.createTitledBorder(".jpg")); 
				...
				}
				{
					...
					jButton2.setBorder(BorderFactory.createTitledBorder("JPEG")); 
...
//		filesList.add("C:\\Documents and Settings\\Administrador\\Mis documentos\\l5\\BAND2.dat");
//		filesList.add("C:\\Documents and Settings\\Administrador\\Mis documentos\\l5\\BAND3.dat");
//		filesList.add("C:\\Documents and Settings\\Administrador\\Mis documentos\\l5\\BAND1.dat");
